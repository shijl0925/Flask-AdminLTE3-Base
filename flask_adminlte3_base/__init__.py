...
class StaticCDN(object):
    ...
    def get_resource_url(self, filename):
        ...
        if self.rev:
            extra_args['adminlte_base'] = __version__
...
def adminlte_find_resource(filename, cdn, use_minified=None, local=True):
    ...
    cdns = current_app.extensions['adminlte_base']['cdns']
...
class AdminLTE3Base(object):
    ...
    def init_app(self, app):
        ...
        blueprint = Blueprint(
            ...
            static_url_path=app.static_url_path + '/adminlte_base')
        ...
        local = StaticCDN('adminlte_base.static')
        static = StaticCDN()
